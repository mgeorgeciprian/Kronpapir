...
REWRITE_ARTICLE_PROMPT = """Rescrie articolul de mai jos păstrând TOATE faptele intacte, dar fă-l să sune ca și cum l-ai scris tu, nu ca un comunicat de presă copy-paste.

Reguli:
- Păstrează fiecare fapt, cifră, nume, dată — nu inventa nimic
- Schimbă complet structura și formulările — nu parafraza mecanic
- Adaugă un unghi uman: cum afectează asta brașovenii? De ce ar trebui să le pese?
...
- Lungime: 200-350 cuvinte. Nu mai mult, cititorii sunt pe telefon
- Prima propoziție trebuie să prindă — nu începe cu "Autoritățile locale au anunțat că..."
- Ultima propoziție trebuie să lase un gust — o reflecție scurtă, o ironie blândă, o întrebare
